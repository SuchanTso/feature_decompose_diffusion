MODEL_PATH="/data/usr/zsc/project/guided-diffusion/models/256x256_diffusion_uncond.pt"
...
SAVE_FLAGS="--images_dir /data/usr/zsc/project/guided-diffusion/datasets/recon --recons_dir /data/usr/zsc/project/guided-diffusion/imgs/recon"
