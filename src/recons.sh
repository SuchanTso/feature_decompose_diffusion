...
SAVE_FLAGS="--images_dir /data/usr/zsc/project/feature_decompose_diffusion/datasets/lsun_bedroom --recons_dir /data/usr/zsc/project/feature_decompose_diffusion/imgs/edit"
