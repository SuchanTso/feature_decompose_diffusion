...
def prepare_dirs(fn_save , args , paths):
    ...
    return input_save_path , origin_sample_save_path
...
def main():
    ...
    while have_finished_images < args.num_samples:
        ...
        input_save_path , origin_sample_save_path = prepare_dirs(fn_save , args , paths)
        ...
        origin_sample, eps_list, adjusted_eps_list = dp.diffusion_inverse(args , batch_size , latent , model_kwargs)
